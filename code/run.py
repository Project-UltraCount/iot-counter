...
from aliyun.get_device_properties import get_device_properties
from aliyun.oss import OSS
from aliyun.property_upload import start_upload, stop_mqtt, resume_mqtt, upload
...
def on_message(client, userdata, msg):
    ...
    for name in params:
        setattr(device_properties, name, params[name])
    print(params)
