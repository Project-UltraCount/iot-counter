...
def getSts():
	...
	AccessKeyID = "LTAI5tHgN6uT3pkpyUvEswof"
	AccessKeySecret = "CeVAftQ9XdLiznCe0xzI2hyl9LRT5I"
	roleArn = "acs:ram::1394721840664016:role/ramosstest"
	...
	# 具体规则请参考API文档中的格式要求
	request.set_RoleSessionName('SessionTest')
